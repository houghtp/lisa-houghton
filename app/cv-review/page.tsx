          ...
          <div className="lg:sticky lg:top-12" style={{ borderTop: "1px solid var(--border)", paddingTop: "2rem" }}>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div><label style={labelStyle}>Link to your CV (Google Doc, Dropbox, etc.)</label><input name="cvLink" type="text" required placeholder="https://" style={inputStyle} /></div>
                <div>
                ...
                <div><label style={labelStyle}>What roles are you targeting?</label><textarea name="targeting" required placeholder="e.g. Graduate designer roles at mid-market womenswear retailers, London-based..." rows={3} style={{ ...inputStyle, resize: "vertical" as const }} /></div>
