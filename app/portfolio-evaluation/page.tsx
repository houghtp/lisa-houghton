            ...
            {[
              {
                ...
                body: "I work through your portfolio project by project — what&rsquo;s working, what isn&rsquo;t, and the specific changes that will make the difference. Delivered as a clear written document you can act on immediately.",
              ...
              <div key={tier.label} className="py-8 pr-8 md:pr-12" style={{ borderTop: "1px solid var(--border)" }}>
                ...
                <p style={{ color: "var(--muted)", fontSize: "0.875rem", lineHeight: 1.75, fontWeight: 300, marginBottom: "1rem" }} dangerouslySetInnerHTML={{ __html: tier.body }} />
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} style={{ maxWidth: "36rem" }}>
              ...
              <div>
                ...
                <input name="portfolioLink" type="url" required placeholder="https://yourportfolio.com" style={inputStyle} />
              </div>
              <div>
              ...
              <div>
                <label style={labelStyle}>Anything specific you&apos;d like me to focus on? (optional)</label>
                <textarea name="focus" placeholder="e.g. I&apos;m applying for womenswear roles, unsure if my styling projects are working..." rows={3} style={{ ...inputStyle, resize: "vertical" as const }} />
              </div>
              <button
                type="submit"
                disabled={loading}
