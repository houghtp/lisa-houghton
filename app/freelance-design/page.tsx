          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} style={{ maxWidth: "36rem" }}>
              ...
              <div>
                ...
                <input name="company" type="text" required placeholder="Brand or agency name" style={inputStyle} />
              </div>
              <div>
                <label style={labelStyle}>Tell me about the project</label>
                <textarea name="brief" required placeholder="What are you working on, and what kind of design input do you need?" rows={5} style={{ ...inputStyle, resize: "vertical" as const }} />
              </div>
              <div>
                <label style={labelStyle}>Timeline / start date</label>
                <input name="timeline" type="text" placeholder="e.g. Looking to start end of June, approx. 6 weeks" style={inputStyle} />
              </div>
              <button
                type="submit"
                disabled={loading}
